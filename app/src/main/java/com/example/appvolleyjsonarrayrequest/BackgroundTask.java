...
public class BackgroundTask {
    Context context;
    ArrayList<Filmes> arrayList;
    String url_json = "http://192.168.0.100/projetovolleyapi/filmes.php";

    public BackgroundTask(Context context){ this.context = context; }

    public ArrayList<Filmes> getList() {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.POST, url_json, null, new Response.Listener<JSONArray>() {
            @Override
